...
export default function About() {
  return (
    <GridLayout>
      <section className="col-start-3 col-span-4 mt-20">
      ...
      <section className="col-start-7 col-span-4 mt-32">
        <p className="text-body mt-8">RELIGHTED IMAGE</p>
      </section>

      <section className="col-start-3 col-span-8 mt-32">
      ...
      <ImageWithCaption
        ...
        classprops="col-start-3 col-span-4"
      />
      <ImageWithCaption
        src="/images/about/arGlasses.jpg"
        caption="Testing VR-Gloves at the Immersive Tech Week 2022 in Rotterdam"
        classprops="col-start-7 col-span-4"
      />
      <section className="col-start-3 col-span-4 mt-2">
        <p>
      ...
      <section className="col-start-7 col-span-4 mt-2">
        <p>
