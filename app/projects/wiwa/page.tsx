        ...
        <GridLayout>
          <section className="col-span-1 md:col-span-8 md:col-start-3 mt-8">
            ...
            <p className="text-body mt-2">
              <span className="text-productname">WiWa</span> is an innovative
              wildlife warning system that combines sensor technology with
              existing road infrastructure to prevent wildlife-vehicle
              collisions. The system uses infrared cameras mounted on road
              markers to detect animal movement and warn drivers through
              multiple channels. By focusing on driver awareness rather than
              animal behavior modification,{" "}
              <span className="text-productname">WiWa</span> offers a more
              sustainable solution to wildlife-vehicle collisions.
            </p>
            <YouTubeEmbed
              videoId="_hmCpOiAVuE"
              caption="Our Video Presentation of the WiWa Project."
            />
          </section>
